...
<head>
    ...
    <!--===============================================================================================-->
        <script src="../public/assets/js/query.min.js"></script>
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row">
            <div class="col-12 col-sm-8" >
                <a href="form_verification.php" class="btn btn-outline-primary">+Ajout Publication</a>
            </div>
                ...
                <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main" method="POST">
                    <div class="form-group mb-0">
                        <div class="input-group input-group-alternative input-group-merge">
                            <input class="form-control" id="search_vend" name="search_vend" placeholder="Recherche" type="text">
        ...
        <div class='row icon-boxes' id='resultat_vend'>
            <?php 
                ...
                if (isset($_POST['search_vend']))
                {
                    ...
                    $sql="SELECT * FROM vente WHERE CONCAT(substance,'',id_vente)  LIKE '%$searchkey%' OR nb_carre LIKE '%$searchkey%' 
                    OR localisation LIKE '%$searchkey%'";
                }else{
                    ...
                    echo "
                        <div class='col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0' data-aos='zoom-in' data-aos-delay='100'>
                            <div class='icon-box'>
                                ...
                                <h4 class='title'> Permis{$row['id_vente']}</h4>
                                <p class='description'>
                                ...
                                <a href='#modal_".$row['id_vente']."' class='btn btn-outline-primary' data-toggle='modal'>Intéressé</a>
                            </div>
            ";
            include('../public/modal/ajoutAcheteur.php');
                }
            ?>   
        </div>
        <script type="text/javascript" src="../public/recherche/recherche_vend.js"></script>
    </div>
</section>
